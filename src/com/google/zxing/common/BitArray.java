 ...
 * @author Sean Owen
 */
@SuppressWarnings("deprecation") // Needed for implementation
public final class BitArray implements Cloneable {
  ...
  public int getNextSet(int from) {
    ...
    int result = (bitsOffset * 32) + j2me.lang.IntegerMethods.numberOfTrailingZeros(currentBits);
  ...
  public BitArray clone() {
	  int[] clonedBits = Arrays.copyOfRange(bits, 0, bits.length);
    return new BitArray(clonedBits, size);
  }

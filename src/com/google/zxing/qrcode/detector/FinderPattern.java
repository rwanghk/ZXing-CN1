 ...
 * patterns, as a convenience to the finder's bookkeeping.</p>
 *
 * @author Sean Owen
 */
public final class FinderPattern extends ResultPoint {
  ...
  void incrementCount() {
	...
	/**
	 * A simple array representing the structure of finder pattern. Please don't 
	 * change it...
	 * @since 20.08.2019
	 */
	...
	/**
	 * Get the state of dot at given coordinate (relative to the top left corner 
	 * of the pattern). 
	 * @param x
	 * @param y
	 * @return The state of dot, if the pattern is indeed a finder
	 */
	static boolean getExpectedDot(int x, int y) {
		return pattern[y * 7 + x];
	}
